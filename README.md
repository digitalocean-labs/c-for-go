...
This project is a (hopefully temporary) fork of [xlab/c-for-go](https://github.com/xlab/c-for-go), enhanced for better
interoperability with the `libvirt` source code.
